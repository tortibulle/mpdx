...
tunnel_ns = namespace :tunnel do 
  ...
  task config: :environment do
   @public_host_username = APP_CONFIG['tunnel']['public_host_username'] 
   @public_host = APP_CONFIG['tunnel']['public_host'] 
   @public_port = APP_CONFIG['tunnel']['public_port'] 
   @local_port = APP_CONFIG['tunnel']['local_port'] 
   @ssh_port = APP_CONFIG['tunnel']['ssh_port'] || 22
