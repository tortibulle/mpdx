Mpdx::Application.configure do
  ...
  config.ssl_options = { exclude: proc { |env| env['PATH_INFO'].start_with?('/up_with_db') } }
  ...
  config.assets.precompile += ['jquery-ui.css'] # Disable delivery errors, bad email addresses will be ignored
