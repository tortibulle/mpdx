...
describe CredentialValidator do
  ...
  describe 'when using requires username and password' do
    ...
    it "should not add error if the record is missing an org" do
      ...
      @record.valid?
      @record.errors.full_messages.should_not include(I18n.t('data_server.invalid_username_password', org: @record.organization))
    end
    ...
    it "should add error if the username and password are invalid" do
      ...
      @record.errors.full_messages.should == [I18n.t('data_server.invalid_username_password', org: @record.organization)]
    end
