...
#gem 'omniauth-prayer-letters', git: 'https://github.com/draffensperger/omniauth-prayer-letters', branch: 'update-to-auth2'
gem 'omniauth-prayer-letters', path: '/home/dave/Dropbox/wmd/omniauth-prayer-letters'
